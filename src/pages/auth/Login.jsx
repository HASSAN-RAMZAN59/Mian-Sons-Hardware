...
import { verifyAccountPassword } from '../../utils/authStore';
...
const Login = () => {
  ...
  const [formData, setFormData] = useState({
    username: '',
    password: '',
    rememberMe: false // still present for UI, but not required for login
  });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const result = await verifyAccountPassword(formData.username, formData.password);
      ...
      if (result.ok) {
        ...
        // Always allow login regardless of rememberMe checkbox
        // If rememberMe is checked, use localStorage, else use sessionStorage
    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary via-blue-700 to-blue-900 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center items-center w-full px-12 text-white">
          {/* Logo */}
          <div className="mb-8">
            <div className="w-32 h-32 bg-white bg-opacity-20 rounded-full overflow-hidden flex items-center justify-center backdrop-blur-sm border-4 border-white border-opacity-30">
              <img src="/images/store-logo.png" alt="Mian & Sons logo" className="w-full h-full object-cover object-center rounded-full" />
            </div>
          </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center bg-gray-50 dark:bg-gray-900 px-6 py-12">
        <div className="w-full max-w-md">
          ...
          <div className="lg:hidden text-center mb-8">
            <div className="inline-flex w-20 h-20 bg-primary rounded-full overflow-hidden items-center justify-center mb-4">
              <img src="/images/store-logo.png" alt="Mian & Sons logo" className="w-full h-full object-cover object-center rounded-full" />
            </div>
