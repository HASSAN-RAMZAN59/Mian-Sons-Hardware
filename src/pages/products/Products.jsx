...
const Products = () => {
  ...
  useEffect(() => {
    ...
    window.dispatchEvent(new CustomEvent('app-storage-updated', { detail: { key: PRODUCTS_KEY } }));
  }, [products]);
  ...
  const handleAddProduct = () => {
    ...
    const newProduct = {
      id: products.length ? Math.max(...products.map((product) => Number(product.id) || 0)) + 1 : 1,
      ...formData,
